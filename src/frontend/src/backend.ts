...
export class Backend implements backendInterface {
    ...
    async getConversation(arg0: ConversationId): Promise<Conversation> {
        if (this.processError) {
            try {
    ...
    async updateConversation(arg0: ConversationId, arg1: string, arg2: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateConversation(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
